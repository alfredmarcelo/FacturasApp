...
export default function Noche({ total_hoy, total_ayer }) {
    ...
    return (
        ...
        >
            ...
            {/* Contenido real */}
            <View style={{ flexDirection: 'row', alignItems: 'center', position: 'absolute', paddingHorizontal: wp('3%'), top: wp('10%'), gap: wp('2%') }}>
                <Texts style={{ fontSize: wp('7%'), fontWeight: '300', color: 'white' }}>
                    Total Ventas
                </Texts>
                ...
                <Texts style={{ position: 'absolute', top: wp('13%'), left: wp('65%'), fontSize: wp('3%'), fontWeight: '300', color: 'white' }}>
                    Ventas ayer
                </Texts>
                <Texts
                    style={{

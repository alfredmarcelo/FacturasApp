...
export default function CotizacionCreada() {
    ...
    <>
      ...
      <View style={styles.container}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 10, justifyContent: 'center', margin: 10 }}>
          <Texts style={{ fontSize: wp('5%') }}>Cotización creada exitosamente</Texts>
          <AntDesign name='check-circle' size={wp('5')} color={'green'} style={{ paddingTop: 5 }} />
        </View>
        <View style={styles.HeaderContainer}>
          <View style={styles.Header}>
            <Texts style={styles.text}>RNC: {rnc_cliente}</Texts>
            ...
            <Texts style={styles.text}>Fecha Validez: {fechaLimite}</Texts>
            <Texts style={styles.text}>Nombre Empresa Receptora: {nombre_cliente}</Texts>

            <Texts style={styles.divider}>-----------------------------------------</Texts>
            <Texts style={styles.title}>COTIZACIÓN</Texts>
            <Texts style={styles.divider}>-----------------------------------------</Texts>
          </View>
